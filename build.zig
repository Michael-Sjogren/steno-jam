...
pub fn build(b: *std.Build) !void {
    ...
    if (target.getOsTag() == .emscripten) {
        ...
        const raylib_artifact = rl.getArtifact(
            b,
            target,
            optimize,
        );
        ...
        const link_step = try rl.linkWithEmscripten(b, &[_]*std.Build.Step.Compile{
            exe_lib,
            raylib_artifact,
        });
        ...
        const run_option = b.step("run", "Run game");
